...
I've been so busy tweaking my blog that forgot to mention my 3rd static blog generator - [jblogfy].

The first one (Blogfy) was written in late 2013-2014. The second one was kinda customized fork of geminiBlog, but the code was so monolithic, [sphagetti] and hard to follow.

So I rolled up my sleeves, made a sketch with the blog logic and started from scratch.

I never would have thought that Javascript will have such an impact on my view, that would drive me to write a static blog generator.

The source code used by **main.js**, compare it to the [sphagetti] code:
...
[jblogfy]: https://github.com/wifiextender/jblogfy
[sphagetti]: https://github.com/wifiextender/geminiblog/blob/gh-pages/js/geminiblog.js
